...
Routes.get('/tasks', Auth.user, AuthRoles.authClient, tasksController.getTask)
...
Routes.post('/tasks/:id/messages', Auth.user, AuthRoles.authWorkerAndClient, messagesController.createMessage)


Routes.get('/tasks/:id/messages', Auth.user, AuthRoles.authWorkerAndClient, messagesController.getMessageFromTask)
